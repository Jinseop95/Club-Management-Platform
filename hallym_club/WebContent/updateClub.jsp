...
<body>
	...
	<div class="main">
		...
		<form method="post" action="clubUpdateAction.jsp"
			...
			<table class="type03">
				...
				<tr>
					<th>동아리 정보</th>
					<td style="text-align: left">개설년도<input type="text"
						name="open_dt" style="font-size: 20px; margin-left: 20px;"
						size="10" maxlength="8" value=<%=list.get(0).getOpen_dt()%>>
						동아리방<input type="text" name="club_room"
				...
				<tr>
					<th>프로필</th>
					<td><input type="file" name="intro_file_nm"></td>
				</tr>

				<tr>
					<th>홍보 포스터</th>
					<td><input type="file" name="intro_file_path"></td>
				</tr>
